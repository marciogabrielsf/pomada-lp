...
export default function Extraction() {
	return (
		<section className="min-h-screen bg-terciary p-10 pt-64 flex justify-center items-center relative">
			...
			<div className="w-[100rem] flex flex-col gap-10">
				<div className="max-w-[50rem] flex flex-col gap-4 ">
					<h1 className="text-alternative font-bold text-6xl">
				...
				<div className="flex flex-row flex-wrap gap-10">
					{images.map(({ id, src, alt }) => (
						<Image
							className="rounded-xl drop-shadow-lg transition-all hover:scale-[103%] hover:drop-shadow-xl"
							width={300}
							key={id}
							src={src}
							alt={alt}
